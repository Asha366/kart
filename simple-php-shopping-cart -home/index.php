...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			$productByCode = $db_handle->runQuery("SELECT * FROM home WHERE code='" . $_GET["code"] . "'");
...
<link href="homee.css" type="text/css" rel="stylesheet"/>
</HEAD>
<BODY>
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top">
        ...
        <div class="container">
            ...
            <ul class="nav-dropdown collapse pull-xs-right navbar-toggleable-sm nav navbar-nav" id="exCollapsingNavbar">
                ...
                <div class="dropdown"><div class="dropdown-menu dropdown-submenu"><!--<a class="dropdown-item" href="https://mobirise.com/">Curtains</a>--></div></div></li>
                <li class="nav-item"><a class="nav-link link" href="../simple-php-shopping-cart/index.php">Men</a></li>

                 <li class="nav-item"><a class="nav-link link" href="../simple-php-shopping-cart-women/index.php">Women</a></li>

                <li class="nav-item"><a class="nav-link link" href="../simple-php-shopping-cart -girl/index.php">Kids</a></li>

                 <li class="nav-item"><a class="nav-link link" href="../simple-php-shopping-cart -home/index.php">Home&Living</a></li>
                <!---------------------------------------------contactus----------------------->
...
<div id="product-grid">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM home ORDER BY id ASC");
